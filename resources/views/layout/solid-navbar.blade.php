        ...
        <div class="collapse navbar-collapse justify-content-md-center" id="navbarPrimary">
          <ul class="navbar-nav">
            <li class="nav-item active">
              <a class="nav-link solid-nav-text" href="#">HOME</a>
            </li>
            <li class="nav-item ">
              <a class="nav-link solid-nav-text" href="#">MENU</a>
            </li>
            <li class="nav-item ">
                <a class="nav-link solid-nav-text" href="#">RESERVATION</a>
            </li>
            <li class="nav-item">
                <a class="nav-link solid-nav-text" href="#">PAGE</a>
            </li>
            <li class="nav-item">
                <a class="nav-link solid-nav-text" href="#">BLOG</a>
            </li>
            <li class="nav-item">
                <a class="nav-link solid-nav-text" href="#">CONTACT</a>
            </li>
          </ul>
